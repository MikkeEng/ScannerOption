...
public final class CaptureActivity extends Activity implements SurfaceHolder.Callback {
    ...
    protected void onResume() {
        ...
        cancel_btn = (Button) findViewById(R.id.btn_cancelScan);
        ...
        //Es posible que el boton no aparezca
        if (cancel_btn != null) {
...
//                else setTorch(false);
    ...
    private void setAutoFocus(boolean setting) {
        if (setting) {
            ...
            autoFocusToggleButton.setImageResource(R.drawable.ic_center_focus_weak_white_18dp);
    ...
    private void setTorch(boolean setting) {
        if (setting) {
            ...
            flashToggleButton.setImageResource(R.drawable.ic_flash_off_white_18dp);
            cameraManager.setTorch(false);
            flash = false;
        }
    }
